  ...
  return (
    <div className="utility-1 relative flex flex-col gap-8">
      ...
      <div className="bg-white p-2 text-center shadow-md text-xl rounded-xl max-w-5xl mx-auto">
        <p className="text-blue-500 ">“Lo que más me gusta de mi profesión es ayudar a las personas a sentirse mejor consigo mismas, recuperar su confianza y mejorar la funcionalidad de su nariz.
        Disfruto del contacto cercano y la relación que tengo con mis pacientes.”</p>
      </div>
